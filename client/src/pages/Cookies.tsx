      ...
      <section className="bg-white py-24 lg:py-32">
        <div className="max-w-[900px] mx-auto px-6 lg:px-12">
          <div className="prose prose-lg max-w-none text-[#736d77]">
            ...
            <h2 className="text-2xl font-medium text-[#16163f] mt-12 mb-4">2. Para que utilizamos cookies?</h2>
            ...
            <h2 className="text-2xl font-medium text-[#16163f] mt-12 mb-4">3. Tipos de cookies utilizados</h2>
            
            <h3 className="text-xl font-medium text-[#16163f] mt-6 mb-3">Cookies Necessários</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#16163f] mt-6 mb-3">Cookies de Desempenho e Análise</h3>
            <p>
              Coletam informações agregadas e anônimas sobre como os visitantes utilizam o site, permitindo melhorias contínuas.
            </p>

            <h3 className="text-xl font-medium text-[#16163f] mt-6 mb-3">Cookies Funcionais</h3>
            <p>
              Permitem lembrar preferências do usuário, como idioma ou região, proporcionando uma experiência mais personalizada.
            </p>

            <h3 className="text-xl font-medium text-[#16163f] mt-6 mb-3">Cookies de Marketing (se aplicável)</h3>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#16163f] mt-12 mb-4">4. Consentimento</h2>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#16163f] mt-12 mb-4">5. Como gerenciar ou desativar cookies</h2>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#16163f] mt-12 mb-4">6. Alterações nesta Política</h2>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#16163f] mt-12 mb-4">7. Contato</h2>
            <p>
