  ...
  return (
    <div className="min-h-screen" style={{ background: "#09081e" }}>
      ...
      <section className="bg-[#13112a] py-24 lg:py-32 border-t border-white/[0.04]">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <h2 className="text-3xl lg:text-4xl font-normal tracking-tight text-white mb-16">
            Cronograma de Abertura do Mercado
          </h2>
          
          <div className="grid md:grid-cols-3 gap-8">
            <div className="rounded-lg p-8" style={{ background: "rgba(158,63,253,0.08)", border: "2px solid rgba(158,63,253,0.4)" }}>
