        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-6 rounded-xl border border-gray-200 hover:border-[#9e3ffd] hover:shadow-lg transition-all" data-testid={`otimizacao-feature-${i}`}>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white rounded-xl p-6 border border-gray-200 hover:border-[#9e3ffd] transition-colors">
                <h3 className="text-lg font-semibold text-[#16163f] mb-2" data-testid={`otimizacao-segment-${i}`}>{item.segment}</h3>
                <p className="text-[#736d77] text-sm leading-relaxed">{item.detail}</p>
              </div>
            ))}
          </div>
        </div>
