...
const WA_FLOAT_URL = "https://wa.me/5521997959777?text=" + encodeURIComponent("Olá! Acessei o site da Ótima Energia e gostaria de saber mais.");
const HIDDEN_PREFIXES = ["/admin", "/portal", "/client", "/proposta", "/proposal"];
