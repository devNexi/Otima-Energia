...
export function CookieConsent() {
  ...
  return (
    <div 
      className="fixed bottom-0 left-0 right-0 z-50 bg-[#16163f] text-white p-4 md:p-6 shadow-lg"
    ...
    >
      <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="bg-[#9e3ffd] hover:bg-[#df0af2] text-white px-8 py-3 text-sm font-medium uppercase tracking-wide transition-colors whitespace-nowrap"
