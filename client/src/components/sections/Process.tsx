  ...
  return (
    <>
      <section className="bg-[#eee7f1] py-16 lg:py-20">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="flex flex-wrap gap-8 lg:gap-16 max-w-4xl">
            <div>
              <p className="text-4xl font-light text-[#9e3ffd]">4</p>
      ...
      <section id="process" className="bg-white py-16 lg:py-20 border-t border-gray-200">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <h2 className="dcvc-section-title mb-4">Como funciona o diagnóstico</h2>
              ...
              <div key={i} className="group">
                <div className="mb-6 rounded-xl overflow-hidden bg-[#eee7f1] flex items-center justify-center h-48">
                  <div className="text-center p-6">
                    ...
                    <span className="text-[#df0af2] font-medium text-sm">{item.iconLabel}</span>
                  </div>
                </div>
                <div className="mb-4">
                  <span className="text-5xl font-light text-[#c88ff5]">{item.num}</span>
                </div>
