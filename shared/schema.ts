...
export const billsExtracted = pgTable("bills_extracted", {
  ...
  consumoPontaKwh: decimal("consumo_ponta_kwh", { precision: 12, scale: 2 }),
  consumoForaPontaKwh: decimal("consumo_fora_ponta_kwh", { precision: 12, scale: 2 }),
  demandaContratadaKw: decimal("demanda_contratada_kw", { precision: 12, scale: 2 }),
  demandaMedidaKw: decimal("demanda_medida_kw", { precision: 12, scale: 2 }),
  fieldConfidence: jsonb("field_confidence"),
  fieldReasons: jsonb("field_reasons"),
...
export const insertBillExtractedSchema = createInsertSchema(billsExtracted).omit({
  ...
  demandaContratadaKw: true,
  demandaMedidaKw: true,
